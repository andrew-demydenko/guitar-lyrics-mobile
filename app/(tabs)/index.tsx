...
export default function HomeScreen() {
  return (
    ...
    >
      <View style={styles.titleContainer} className="bg-cyan-600">
        <Text type="title">Welcomeeee!</Text>
        <HelloWave />
      </View>
      ...
      <View className="w-24 h-24 bg-border">
        <Text className="text-background">Test</Text>
      </View>
    </ParallaxScrollView>
  );
}
